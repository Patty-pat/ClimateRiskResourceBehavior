...
def shock_occ(label):
    return models.IntegerField(
        choices=[
            [0, "Vor der ersten Runde"],
            [1, "Nach der ersten Runde"],
...
def trees_start(label):
    return models.IntegerField(
        choices=[[0, "100 Bäumen"], [1, "50 Bäumen"], [3, "30 Bäumen"]],
        widget=widgets.RadioSelectHorizontal,
        label=label,
    )
...
class Player(BasePlayer):
    ...
    compr4 = max_take(
        label="4. Wenn nur 3 Bäume im Wald vorhanden sind, wie viele Bäume darf jedes Gruppenmitglied entnehmen?",
    )
    num_failed_attempts = models.IntegerField(initial=0)
    take_max7 = models.IntegerField(
        min=C.MIN_TAKE,
        max=C.MAX_TAKE7,
        label="Wie viele Bäume möchten Sie entnehmen?",
    )
    take_max6 = models.IntegerField(
        min=C.MIN_TAKE,
        max=C.MAX_TAKE6,
        label="Wie viele Bäume möchten Sie entnehmen?",
    )
    take_max5 = models.IntegerField(
        min=C.MIN_TAKE,
        max=C.MAX_TAKE5,
        label="Wie viele Bäume möchten Sie entnehmen?",
    )
    take_max4 = models.IntegerField(
        min=C.MIN_TAKE,
        max=C.MAX_TAKE4,
        label="Wie viele Bäume möchten Sie entnehmen?",
    )
    take_max3 = models.IntegerField(
        min=C.MIN_TAKE,
        max=C.MAX_TAKE3,
        label="Wie viele Bäume möchten Sie entnehmen?",
    )
    take_max2 = models.IntegerField(
        min=C.MIN_TAKE,
        max=C.MAX_TAKE2,
        label="Wie viele Bäume möchten Sie entnehmen?",
    )
    take_max1 = models.IntegerField(
        min=C.MIN_TAKE,
        max=C.MAX_TAKE1,
        label="Wie viele Bäume möchten Sie entnehmen?",
    )
    take_max0 = models.IntegerField(
        min=C.MIN_TAKE,
        max=C.MAX_TAKE0,
        label="Wie viele Bäume möchten Sie entnehmen?",
    )
...
class P05ComprehensionCheckS(Page):
    ...
    def error_message(player: Player, values):
        solutions = {"compr1": 0, "compr2": 1, "compr3": 1, "compr4": 1}
        names = {
            "compr1": "Frage 1",
            "compr2": "Frage 2",
            "compr3": "Frage 3",
...
class Forest1(Page):
    ...
    def vars_for_template(player: Player):
        ...
        return {
            "ceiling_group_take": group.ceiling_group_take,
        }
...
class Results(Page):
    ...
    def vars_for_template(player: Player):
        ...
        player.stage_points = round(
            player.balance
            + p1.participant.current_trees * C.MULTIPLIER_GROUP / C.PLAYERS_PER_GROUP,
            2,
        )
        return {
