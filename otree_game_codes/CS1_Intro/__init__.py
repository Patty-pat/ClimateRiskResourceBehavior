...
class Player(BasePlayer):
    ...
    compr1 = my_field(
        "1. Erhalten Sie Punkte für die Anzahl der Bäume, die am Ende der 5. Runde im Wald stehen?",
    )
    compr2 = my_field(
        "2. Hängt die Anzahl der Bäume am Ende der 5. Runde nur von Ihren Entscheidungen ab? ",
    )
    compr3 = models.IntegerField(
        label="3. Bis zu wie viele Bäume kann jedes Gruppenmitglied in jeder Runde maximal entnehmen?",
    )
    compr4 = my_field(
        "4. Können Sie frei entscheiden, wie viele Bäume Sie in jeder Runde entnehmen wollen (unter der Beschränkung aus der vorherigen Frage)?",
    )
...
class P05ComprehensionCheck(Page):
    ...
    @staticmethod
    def error_message(player: Player, values):
        solutions = {"compr1": 1, "compr2": 0, "compr3": 7, "compr4": 1, "compr5": 0}
        names = {
            "compr1": "Frage 1",
            "compr2": "Frage 2",
            "compr3": "Frage 3",
